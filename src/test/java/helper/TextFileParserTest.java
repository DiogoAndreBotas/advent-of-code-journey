...
public class TextFileParserTest {
    ...
    public void parse5Lines() {
        File file = new File("./src/test/resources/5_lines.txt");

        try {
            List<String> lines = TextFileParser.parse(file);
    ...
    public void parse100Lines() {
        File file = new File("./src/test/resources/100_lines.txt");
    ...
    public void parse1000Lines() {
        File file = new File("./src/test/resources/1000_lines.txt");
    ...
    public void parse0Lines() {
        File file = new File("./src/test/resources/0_lines.txt");
    ...
    public void throwExceptionIfFileExtensionIsNotSupported() {
        File file = new File("./src/test/resources/unsupported_extension.doc");
    ...
    public void throwExceptionIfFileDoesNotExist() {
        File file = new File("./src/test/resources/i_do_not_exist.wow");
